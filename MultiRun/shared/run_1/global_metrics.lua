_report = {
  metrics = {
    ...
    loops_time = 41.26,
    speedup_if_fp_vect = 1.0406,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.968728003198,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0071507704703,
    ...
    speedup_if_fully_vectorised = 1.304,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.0051188915985,
    speedup_if_clean = 1.0056,
    profiled_time = 10.81,
    array_access_efficiency = 88.462680160936,
    crest_performance = "Not Implemented Yet",
    number_processes = 6,
    speedup_if_FP_only = 1.1386,
    nb_threads = 9,
    application_time = 10.813045501709,
    compilation_options = "OK",
    innerloops_time = 39.64,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 4.46 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 4.29 seconds.",
  },
  colors = {
