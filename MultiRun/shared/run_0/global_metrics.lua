_report = {
  metrics = {
    ...
    loops_time = 49.5,
    speedup_if_fp_vect = 1.0501,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 2.1921838879376,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.007962906965,
    ...
    speedup_if_fully_vectorised = 1.387,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.0065917963596,
    speedup_if_clean = 1.0056,
    profiled_time = 12.19,
    array_access_efficiency = 88.395854001323,
    crest_performance = "Not Implemented Yet",
    number_processes = 4,
    speedup_if_FP_only = 1.1678,
    nb_threads = 10,
    application_time = 12.185119628906,
    compilation_options = "OK",
    innerloops_time = 48.07,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 6.03 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 5.86 seconds.",
  },
  colors = {
