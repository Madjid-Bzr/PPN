_report = {
  metrics = {
    ...
    loops_time = 24.51,
    speedup_if_fp_vect = 1.0245,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 4.3703508491349,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0038527926845,
    nb_loops_80_if_FP_only = 5,
    GFlops = "Not Implemented Yet",
    speedup_if_L1 = "Not Available",
    GBs = "Not Implemented Yet",
    nb_loops_80_if_fully_vect = 10,
    nb_loops_80_if_perfect_openmp = "Not Available",
    nb_loops_80_if_clean = 7,
    speedup_if_fully_vectorised = 1.1618,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.0026841211567,
    speedup_if_clean = 1.0023,
    profiled_time = 10.63,
    array_access_efficiency = 88.015199443846,
    crest_performance = "Not Implemented Yet",
    number_processes = 10,
    speedup_if_FP_only = 1.0749,
    nb_threads = 21,
    application_time = 10.631021499634,
    compilation_options = "OK",
    innerloops_time = 23.86,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 2.61 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 2.54 seconds.",
  },
  colors = {
