_report = {
  metrics = {
    ...
    loops_time = 98.37,
    speedup_if_fp_vect = 1.8481,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0105757290359,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.007455168245,
    ...
    speedup_if_fully_vectorised = 5.4507,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.2728719172633,
    speedup_if_clean = 1.0659,
    profiled_time = 13.56,
    array_access_efficiency = 66.1140210123,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.4262,
    nb_threads = 8,
    application_time = 14.121549606323,
    compilation_options = "OK",
    innerloops_time = 93.74,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 13.34 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 12.71 seconds.",
  },
  colors = {
