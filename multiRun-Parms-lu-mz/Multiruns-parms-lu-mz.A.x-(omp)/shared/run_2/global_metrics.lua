_report = {
  metrics = {
    ...
    loops_time = 96.33,
    speedup_if_fp_vect = 1.8381,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.1316808806085,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0037137408411,
    ...
    speedup_if_fully_vectorised = 5.031,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.2742911755336,
    speedup_if_clean = 1.062,
    profiled_time = 40.26,
    array_access_efficiency = 66.312569807026,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.3999,
    nb_threads = 3,
    application_time = 41.426555633545,
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 38.78 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 37.04 seconds.",
  },
  colors = {
