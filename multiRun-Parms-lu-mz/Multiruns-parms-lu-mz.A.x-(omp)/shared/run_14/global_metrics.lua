_report = {
  metrics = {
    ...
    loops_time = 82.38,
    speedup_if_fp_vect = 1.6233,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.8329363701841,
    ...
    speedup_if_fully_vectorised = 3.1515,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.2168966094218,
    speedup_if_clean = 1.0546,
    profiled_time = 13.18,
    array_access_efficiency = 66.193351222421,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.3346,
    nb_threads = 15,
    application_time = 13.828831672668,
    compilation_options = "OK",
    innerloops_time = 78.44,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 10.86 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 10.34 seconds.",
  },
  colors = {
