_report = {
  metrics = {
    ...
    loops_time = 92.62,
    speedup_if_fp_vect = 1.7531,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.2749486579304,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.01227797631,
    ...
    speedup_if_fully_vectorised = 4.2862,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.2450005446877,
    speedup_if_clean = 1.0624,
    profiled_time = 13.56,
    array_access_efficiency = 66.151094228725,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.3976,
    nb_threads = 10,
    application_time = 14.124835014343,
    compilation_options = "OK",
    innerloops_time = 88.09,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 12.56 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 11.95 seconds.",
  },
  colors = {
