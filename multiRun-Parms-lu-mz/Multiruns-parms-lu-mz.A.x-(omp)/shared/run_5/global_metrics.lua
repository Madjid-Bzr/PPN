_report = {
  metrics = {
    ...
    loops_time = 96.15,
    speedup_if_fp_vect = 1.7721,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.1312288532894,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0049241282283,
    ...
    speedup_if_fully_vectorised = 4.8268,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.2469022272791,
    speedup_if_clean = 1.0695,
    profiled_time = 20.27,
    array_access_efficiency = 65.673627925467,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.4479,
    nb_threads = 6,
    application_time = 20.977228164673,
    compilation_options = "OK",
    innerloops_time = 91.41,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 19.49 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 18.53 seconds.",
  },
  colors = {
