_report = {
  metrics = {
    ...
    loops_time = 98.3,
    speedup_if_fp_vect = 1.8511,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0100112260295,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0041410673368,
    ...
    speedup_if_fully_vectorised = 5.4417,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.2728719172633,
    speedup_if_clean = 1.0641,
    profiled_time = 53.94,
    array_access_efficiency = 66.281871710687,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.4234,
    nb_threads = 2,
    application_time = 55.419746398926,
    compilation_options = "OK",
    innerloops_time = 93.81,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 53.02 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 50.60 seconds.",
  },
  colors = {
