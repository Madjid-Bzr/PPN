_report = {
  metrics = {
    ...
    loops_time = 94.61,
    speedup_if_fp_vect = 1.8063,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.1533288952125,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.015291665097,
    nb_loops_80_if_FP_only = 15,
    ...
    speedup_if_fully_vectorised = 4.6864,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.2706076681173,
    speedup_if_clean = 1.0615,
    profiled_time = 13.61,
    array_access_efficiency = 66.367418112704,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.3901,
    nb_threads = 9,
    application_time = 14.136480331421,
    compilation_options = "OK",
    innerloops_time = 90.09,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 12.88 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 12.26 seconds.",
  },
  colors = {
