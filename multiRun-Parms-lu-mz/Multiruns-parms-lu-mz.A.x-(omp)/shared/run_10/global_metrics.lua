_report = {
  metrics = {
    ...
    loops_time = 90.93,
    speedup_if_fp_vect = 1.7372,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.3876196526147,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0115612334473,
    ...
    speedup_if_fully_vectorised = 4.0572,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.2454075596239,
    speedup_if_clean = 1.0611,
    profiled_time = 13.54,
    array_access_efficiency = 66.12138490071,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.3831,
    nb_threads = 11,
    application_time = 14.046405792236,
    compilation_options = "OK",
    innerloops_time = 86.52,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 12.31 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 11.71 seconds.",
  },
  colors = {
