_report = {
  metrics = {
    ...
    loops_time = 86.27,
    speedup_if_fp_vect = 1.6723,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.6432595380138,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0125770788296,
    nb_loops_80_if_FP_only = 13,
    GFlops = "Not Implemented Yet",
    speedup_if_L1 = "Not Available",
    GBs = "Not Implemented Yet",
    nb_loops_80_if_fully_vect = 20,
    nb_loops_80_if_perfect_openmp = "Not Available",
    nb_loops_80_if_clean = 6,
    speedup_if_fully_vectorised = 3.5075,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.230523126144,
    speedup_if_clean = 1.0582,
    profiled_time = 13.71,
    array_access_efficiency = 66.203066098791,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.3583,
    nb_threads = 13,
    application_time = 14.343848228455,
    compilation_options = "OK",
    innerloops_time = 82.06,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 11.83 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 11.25 seconds.",
  },
  colors = {
