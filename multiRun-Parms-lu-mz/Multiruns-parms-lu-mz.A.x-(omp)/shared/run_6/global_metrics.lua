_report = {
  metrics = {
    ...
    loops_time = 92.15,
    speedup_if_fp_vect = 1.7537,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.3216024252494,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.005325562701,
    ...
    speedup_if_fully_vectorised = 4.2442,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.2447293491621,
    speedup_if_clean = 1.0616,
    profiled_time = 20.01,
    array_access_efficiency = 66.105878467731,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.392,
    nb_threads = 7,
    application_time = 20.634969711304,
    compilation_options = "OK",
    innerloops_time = 87.81,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 18.44 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 17.57 seconds.",
  },
  colors = {
