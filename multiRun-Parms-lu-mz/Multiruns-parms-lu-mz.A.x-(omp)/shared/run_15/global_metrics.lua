_report = {
  metrics = {
    ...
    loops_time = 94.73,
    speedup_if_fp_vect = 1.7818,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0517322394181,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0242482467707,
    ...
    speedup_if_fully_vectorised = 4.6571,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.2656825984464,
    speedup_if_clean = 1.0634,
    profiled_time = 7.4,
    array_access_efficiency = 66.29545638684,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.4096,
    nb_threads = 16,
    application_time = 8.0233974456787,
    compilation_options = "OK",
    innerloops_time = 90.53,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 7.01 seconds.",
