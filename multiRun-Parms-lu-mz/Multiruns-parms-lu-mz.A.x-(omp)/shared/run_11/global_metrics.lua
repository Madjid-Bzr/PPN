_report = {
  metrics = {
    ...
    loops_time = 88.55,
    speedup_if_fp_vect = 1.7174,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.5119649467998,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0122482032594,
    nb_loops_80_if_FP_only = 14,
    GFlops = "Not Implemented Yet",
    speedup_if_L1 = "Not Available",
    GBs = "Not Implemented Yet",
    nb_loops_80_if_fully_vect = 21,
    nb_loops_80_if_perfect_openmp = "Not Available",
    nb_loops_80_if_clean = 7,
    speedup_if_fully_vectorised = 3.7822,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.2500390637207,
    speedup_if_clean = 1.0573,
    profiled_time = 13.64,
    array_access_efficiency = 66.366568985853,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.359,
    nb_threads = 12,
    application_time = 14.409913063049,
    compilation_options = "OK",
    innerloops_time = 84.54,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 12.08 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 11.53 seconds.",
  },
  colors = {
