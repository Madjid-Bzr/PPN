_report = {
  metrics = {
    ...
    loops_time = 84.4,
    speedup_if_fp_vect = 1.6436,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.7555710065958,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.009998990001,
    ...
    speedup_if_fully_vectorised = 3.328,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.2223631335279,
    speedup_if_clean = 1.0571,
    profiled_time = 13.55,
    array_access_efficiency = 66.127685438242,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.3496,
    nb_threads = 14,
    application_time = 14.157541275024,
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 11.44 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 10.88 seconds.",
  },
  colors = {
