_report = {
  metrics = {
    ...
    loops_time = 98.56,
    speedup_if_fp_vect = 1.8507,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0081009028356,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0061374383741,
    nb_loops_80_if_FP_only = 14,
    GFlops = "Not Implemented Yet",
    speedup_if_L1 = "Not Available",
    GBs = "Not Implemented Yet",
    nb_loops_80_if_fully_vect = 24,
    nb_loops_80_if_perfect_openmp = "Not Available",
    nb_loops_80_if_clean = 7,
    speedup_if_fully_vectorised = 5.4603,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.2747175703883,
    speedup_if_clean = 1.0662,
    profiled_time = 27,
    array_access_efficiency = 66.199858085611,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.4284,
    nb_threads = 4,
    application_time = 27.924238204956,
    compilation_options = "OK",
    innerloops_time = 93.67,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 26.61 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 25.29 seconds.",
  },
  colors = {
