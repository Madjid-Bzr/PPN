_report = {
  metrics = {
    ...
    loops_time = 93.65,
    speedup_if_fp_vect = 1.7677,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.2335851114602,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.004016064257,
    ...
    speedup_if_fully_vectorised = 4.456,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.2496290163858,
    speedup_if_clean = 1.0641,
    profiled_time = 26.08,
    array_access_efficiency = 66.003725649582,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.4061,
    nb_threads = 5,
    application_time = 27.020254135132,
    compilation_options = "OK",
    innerloops_time = 89.01,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 24.42 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 23.21 seconds.",
  },
  colors = {
