_report = {
  metrics = {
    ...
    loops_time = 82.39,
    speedup_if_fp_vect = 1.6657,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.1889524909026,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0978605370314,
    ...
    speedup_if_fully_vectorised = 3.1448,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.2136850829814,
    speedup_if_clean = 1.0602,
    profiled_time = 20.83,
    array_access_efficiency = 68.085258451402,
    crest_performance = "Not Implemented Yet",
    number_processes = 6,
    speedup_if_FP_only = 1.3057,
    nb_threads = 6,
    application_time = 22.108818054199,
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 17.16 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 16.04 seconds.",
  },
  colors = {
