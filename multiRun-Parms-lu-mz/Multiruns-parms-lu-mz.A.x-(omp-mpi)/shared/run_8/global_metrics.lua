_report = {
  metrics = {
    ...
    loops_time = 83.84,
    speedup_if_fp_vect = 1.4836,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.182357140265,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.1035078959195,
    ...
    speedup_if_fully_vectorised = 2.3203,
    nb_loops_80_if_fp_vect = 6,
    flow_complexity = 1.1735618851581,
    speedup_if_clean = 1.0459,
    profiled_time = 9.64,
    array_access_efficiency = 73.638369418687,
    crest_performance = "Not Implemented Yet",
    number_processes = 2,
    speedup_if_FP_only = 1.2562,
    nb_threads = 16,
    application_time = 10.358234405518,
    compilation_options = "OK",
    innerloops_time = 80.18,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 8.08 seconds.",
