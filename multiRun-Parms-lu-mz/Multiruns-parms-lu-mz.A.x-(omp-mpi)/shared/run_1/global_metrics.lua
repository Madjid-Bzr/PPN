_report = {
  metrics = {
    ...
    loops_time = 98.19,
    speedup_if_fp_vect = 1.8789,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0107975768457,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0078252279347,
    ...
    speedup_if_fully_vectorised = 5.3528,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.2774374773402,
    speedup_if_clean = 1.0627,
    profiled_time = 55.67,
    array_access_efficiency = 68.03596733106,
    crest_performance = "Not Implemented Yet",
    number_processes = 2,
    speedup_if_FP_only = 1.3961,
    nb_threads = 2,
    application_time = 57.283802032471,
    compilation_options = "OK",
    innerloops_time = 94.36,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 54.66 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 52.53 seconds.",
  },
  colors = {
