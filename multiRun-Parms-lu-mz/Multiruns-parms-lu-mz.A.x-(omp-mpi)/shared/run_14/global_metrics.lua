_report = {
  metrics = {
    ...
    loops_time = 98.04,
    speedup_if_fp_vect = 1.8687,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0118614113071,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0102208038641,
    ...
    speedup_if_fully_vectorised = 5.2744,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.2767154423753,
    speedup_if_clean = 1.0651,
    profiled_time = 28.11,
    array_access_efficiency = 67.847519988367,
    crest_performance = "Not Implemented Yet",
    number_processes = 4,
    speedup_if_FP_only = 1.3995,
    nb_threads = 4,
    application_time = 29.345336914063,
    compilation_options = "OK",
    innerloops_time = 93.99,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 27.56 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 26.42 seconds.",
  },
  colors = {
