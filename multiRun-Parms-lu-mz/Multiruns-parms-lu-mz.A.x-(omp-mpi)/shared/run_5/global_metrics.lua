_report = {
  metrics = {
    ...
    loops_time = 88.44,
    speedup_if_fp_vect = 1.6336,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.119169614696,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0687802812443,
    ...
    speedup_if_fully_vectorised = 3.0102,
    nb_loops_80_if_fp_vect = 6,
    flow_complexity = 1.2136812418933,
    speedup_if_clean = 1.0514,
    profiled_time = 12.89,
    array_access_efficiency = 70.789436039656,
    crest_performance = "Not Implemented Yet",
    number_processes = 2,
    speedup_if_FP_only = 1.3003,
    nb_threads = 10,
    application_time = 13.687057495117,
    compilation_options = "OK",
    innerloops_time = 84.75,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 11.40 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 10.92 seconds.",
  },
  colors = {
