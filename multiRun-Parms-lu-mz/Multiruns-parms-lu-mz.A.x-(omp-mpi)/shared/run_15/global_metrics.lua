_report = {
  metrics = {
    ...
    loops_time = 94.11,
    speedup_if_fp_vect = 1.7934,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0592863325943,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0382232262994,
    ...
    speedup_if_fully_vectorised = 4.1931,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.247054504747,
    speedup_if_clean = 1.0581,
    profiled_time = 14.25,
    array_access_efficiency = 68.722759106218,
    crest_performance = "Not Implemented Yet",
    number_processes = 4,
    speedup_if_FP_only = 1.354,
    nb_threads = 8,
    application_time = 15.16574382782,
    compilation_options = "OK",
    innerloops_time = 90.23,
  },
  help = {
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 12.86 seconds.",
  },
  colors = {
