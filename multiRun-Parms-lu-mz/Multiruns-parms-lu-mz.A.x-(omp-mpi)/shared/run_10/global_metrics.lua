_report = {
  metrics = {
    ...
    loops_time = 79.96,
    speedup_if_fp_vect = 1.533,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.2359882182381,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.1106175033319,
    ...
    speedup_if_fully_vectorised = 2.5373,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.1862337960758,
    speedup_if_clean = 1.0569,
    profiled_time = 24.86,
    array_access_efficiency = 70.458673100933,
    crest_performance = "Not Implemented Yet",
    number_processes = 3,
    speedup_if_FP_only = 1.2788,
    nb_threads = 6,
    application_time = 26.520486831665,
    compilation_options = "OK",
    innerloops_time = 74.55,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 19.88 seconds.",
