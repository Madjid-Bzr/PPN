_report = {
  metrics = {
    ...
    loops_time = 91,
    speedup_if_fp_vect = 1.7324,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0991217953984,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0729148917121,
    ...
    speedup_if_fully_vectorised = 3.7442,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.233860229784,
    speedup_if_clean = 1.0557,
    profiled_time = 7.43,
    array_access_efficiency = 68.712218887022,
    crest_performance = "Not Implemented Yet",
    number_processes = 8,
    speedup_if_FP_only = 1.3445,
    nb_threads = 16,
    application_time = 8.5534620285034,
    compilation_options = "OK",
    innerloops_time = 87.36,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 6.76 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 6.49 seconds.",
  },
  colors = {
