_report = {
  metrics = {
    ...
    loops_time = 69.65,
    speedup_if_fp_vect = 1.3359,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.4658750845284,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.1422044545974,
    ...
    speedup_if_fully_vectorised = 1.712,
    nb_loops_80_if_fp_vect = 6,
    flow_complexity = 1.1117120614225,
    speedup_if_clean = 1.0322,
    profiled_time = 16.3,
    array_access_efficiency = 78.225095254987,
    crest_performance = "Not Implemented Yet",
    number_processes = 5,
    speedup_if_FP_only = 1.1446,
    nb_threads = 15,
    application_time = 19.063026428223,
    compilation_options = "OK",
    innerloops_time = 65.41,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 11.35 seconds.",
