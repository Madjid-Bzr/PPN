_report = {
  metrics = {
    ...
    loops_time = 88.72,
    speedup_if_fp_vect = 1.6036,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.1291554086781,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0930394097063,
    ...
    speedup_if_fully_vectorised = 2.8557,
    nb_loops_80_if_fp_vect = 6,
    flow_complexity = 1.2028274210997,
    speedup_if_clean = 1.0504,
    profiled_time = 8.34,
    array_access_efficiency = 71.634322092274,
    crest_performance = "Not Implemented Yet",
    number_processes = 4,
    speedup_if_FP_only = 1.2918,
    nb_threads = 16,
    application_time = 9.1123275756836,
    compilation_options = "OK",
    innerloops_time = 85.04,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 7.40 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 7.09 seconds.",
  },
  colors = {
