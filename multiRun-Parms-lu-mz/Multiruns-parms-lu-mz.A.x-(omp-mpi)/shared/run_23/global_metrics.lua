_report = {
  metrics = {
    ...
    loops_time = 95.96,
    speedup_if_fp_vect = 1.8212,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0282585852052,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.023506338306,
    ...
    speedup_if_fully_vectorised = 4.7781,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.2638754931979,
    speedup_if_clean = 1.0641,
    profiled_time = 14.32,
    array_access_efficiency = 67.781028517812,
    crest_performance = "Not Implemented Yet",
    number_processes = 8,
    speedup_if_FP_only = 1.393,
    nb_threads = 8,
    application_time = 15.62250995636,
    compilation_options = "OK",
    innerloops_time = 91.75,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 13.74 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 13.14 seconds.",
  },
  colors = {
