_report = {
  metrics = {
    ...
    loops_time = 78.86,
    speedup_if_fp_vect = 1.5127,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.2414687745746,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.1241007194245,
    ...
    speedup_if_fully_vectorised = 2.4713,
    nb_loops_80_if_fp_vect = 6,
    flow_complexity = 1.1802384316116,
    speedup_if_clean = 1.058,
    profiled_time = 12.59,
    array_access_efficiency = 70.279645388587,
    crest_performance = "Not Implemented Yet",
    number_processes = 6,
    speedup_if_FP_only = 1.2798,
    nb_threads = 12,
    application_time = 13.923259735107,
    compilation_options = "OK",
    innerloops_time = 73.16,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 9.93 seconds.",
