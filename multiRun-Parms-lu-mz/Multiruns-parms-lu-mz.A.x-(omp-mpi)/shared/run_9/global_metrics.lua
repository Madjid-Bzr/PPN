_report = {
  metrics = {
    ...
    loops_time = 81.63,
    speedup_if_fp_vect = 1.6592,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.2022028376887,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.096010521701,
    ...
    speedup_if_fully_vectorised = 3.086,
    nb_loops_80_if_fp_vect = 6,
    flow_complexity = 1.2120194808052,
    speedup_if_clean = 1.059,
    profiled_time = 41.38,
    array_access_efficiency = 68.119526042851,
    crest_performance = "Not Implemented Yet",
    number_processes = 3,
    speedup_if_FP_only = 1.2951,
    nb_threads = 3,
    application_time = 42.920501708984,
    compilation_options = "OK",
    innerloops_time = 76.55,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 33.78 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 31.68 seconds.",
  },
  colors = {
