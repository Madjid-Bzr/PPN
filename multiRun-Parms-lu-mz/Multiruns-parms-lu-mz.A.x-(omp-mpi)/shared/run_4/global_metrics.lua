_report = {
  metrics = {
    ...
    loops_time = 90.42,
    speedup_if_fp_vect = 1.6277,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0979351056578,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0724376481163,
    ...
    speedup_if_fully_vectorised = 3.0118,
    nb_loops_80_if_fp_vect = 6,
    flow_complexity = 1.2075297275476,
    speedup_if_clean = 1.0523,
    profiled_time = 16.14,
    array_access_efficiency = 71.299713061553,
    crest_performance = "Not Implemented Yet",
    number_processes = 2,
    speedup_if_FP_only = 1.3034,
    nb_threads = 8,
    application_time = 17.008863449097,
    compilation_options = "OK",
    innerloops_time = 86.71,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 14.59 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 13.99 seconds.",
  },
  colors = {
