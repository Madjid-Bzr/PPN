_report = {
  metrics = {
    ...
    loops_time = 80.04,
    speedup_if_fp_vect = 1.6318,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.2217911091198,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.1166503968563,
    ...
    speedup_if_fully_vectorised = 2.9584,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.2090627056651,
    speedup_if_clean = 1.0586,
    profiled_time = 10.78,
    array_access_efficiency = 68.089405092855,
    crest_performance = "Not Implemented Yet",
    number_processes = 12,
    speedup_if_FP_only = 1.2938,
    nb_threads = 12,
    application_time = 12.457920074463,
    compilation_options = "OK",
    innerloops_time = 74.7,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 8.63 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 8.05 seconds.",
  },
  colors = {
