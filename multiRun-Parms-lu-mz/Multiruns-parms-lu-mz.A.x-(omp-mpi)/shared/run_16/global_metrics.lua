_report = {
  metrics = {
    ...
    loops_time = 90.91,
    speedup_if_fp_vect = 1.7154,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0967310298768,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.061938882294,
    ...
    speedup_if_fully_vectorised = 3.547,
    nb_loops_80_if_fp_vect = 6,
    flow_complexity = 1.2222479892604,
    speedup_if_clean = 1.056,
    profiled_time = 10.03,
    array_access_efficiency = 69.279915510188,
    crest_performance = "Not Implemented Yet",
    number_processes = 4,
    speedup_if_FP_only = 1.3309,
    nb_threads = 12,
    application_time = 10.886685371399,
    compilation_options = "OK",
    innerloops_time = 86.91,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 9.12 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 8.72 seconds.",
  },
  colors = {
