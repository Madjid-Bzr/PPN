_report = {
  metrics = {
    ...
    loops_time = 92.71,
    speedup_if_fp_vect = 1.7256,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.070931226647,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0450517995744,
    ...
    speedup_if_fully_vectorised = 3.6768,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.2293515623374,
    speedup_if_clean = 1.0577,
    profiled_time = 19.62,
    array_access_efficiency = 69.460541395628,
    crest_performance = "Not Implemented Yet",
    number_processes = 2,
    speedup_if_FP_only = 1.342,
    nb_threads = 6,
    application_time = 20.547668457031,
    compilation_options = "OK",
    innerloops_time = 88.75,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 18.19 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 17.41 seconds.",
  },
  colors = {
