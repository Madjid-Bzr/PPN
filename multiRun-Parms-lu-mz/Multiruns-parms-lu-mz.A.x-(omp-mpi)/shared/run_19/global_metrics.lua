_report = {
  metrics = {
    ...
    loops_time = 72.65,
    speedup_if_fp_vect = 1.4786,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.3563097804215,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.1409013120365,
    nb_loops_80_if_FP_only = 22,
    ...
    speedup_if_fully_vectorised = 2.1199,
    nb_loops_80_if_fp_vect = 6,
    flow_complexity = 1.1526263875587,
    speedup_if_clean = 1.0393,
    profiled_time = 17.78,
    array_access_efficiency = 73.376777489473,
    crest_performance = "Not Implemented Yet",
    number_processes = 5,
    speedup_if_FP_only = 1.1828,
    nb_threads = 10,
    application_time = 19.744306564331,
    compilation_options = "OK",
    innerloops_time = 67.63,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 12.92 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 12.02 seconds.",
  },
  colors = {
