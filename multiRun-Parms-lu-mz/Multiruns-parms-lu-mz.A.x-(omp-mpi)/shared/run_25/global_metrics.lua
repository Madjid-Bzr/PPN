_report = {
  metrics = {
    ...
    loops_time = 64.36,
    speedup_if_fp_vect = 1.2767,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.5787299143369,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.165556970701,
    ...
    speedup_if_fully_vectorised = 1.6738,
    nb_loops_80_if_fp_vect = 6,
    flow_complexity = 1.0940146170496,
    speedup_if_clean = 1.0338,
    profiled_time = 4.26,
    array_access_efficiency = 74.791802186644,
    crest_performance = "Not Implemented Yet",
    number_processes = 9,
    speedup_if_FP_only = 1.1906,
    nb_threads = 90,
    application_time = 5.4140710830688,
    compilation_options = "OK",
    innerloops_time = 62.18,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 2.74 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 2.65 seconds.",
  },
  colors = {
