_report = {
  metrics = {
    ...
    loops_time = 63.82,
    speedup_if_fp_vect = 1.0332,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.7230553331251,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0926647067783,
    nb_loops_80_if_FP_only = 19,
    GFlops = "Not Implemented Yet",
    speedup_if_L1 = "Not Available",
    GBs = "Not Implemented Yet",
    nb_loops_80_if_fully_vect = 15,
    nb_loops_80_if_perfect_openmp = "Not Available",
    nb_loops_80_if_clean = 8,
    speedup_if_fully_vectorised = 1.0612,
    nb_loops_80_if_fp_vect = 6,
    flow_complexity = 1.011258708189,
    speedup_if_clean = 1.0057,
    profiled_time = 25.94,
    array_access_efficiency = 96.709166031092,
    crest_performance = "Not Implemented Yet",
    number_processes = 10,
    speedup_if_FP_only = 1.0223,
    nb_threads = 160,
    application_time = 35.678405761719,
    compilation_options = "OK",
    innerloops_time = 63.01,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 16.55 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 16.34 seconds.",
  },
  colors = {
