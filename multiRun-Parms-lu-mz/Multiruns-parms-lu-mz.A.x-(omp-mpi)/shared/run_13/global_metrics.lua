_report = {
  metrics = {
    ...
    loops_time = 68.55,
    speedup_if_fp_vect = 1.2548,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.4959352843661,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.1389521640091,
    nb_loops_80_if_FP_only = 16,
    GFlops = "Not Implemented Yet",
    speedup_if_L1 = "Not Available",
    GBs = "Not Implemented Yet",
    nb_loops_80_if_fully_vect = 16,
    nb_loops_80_if_perfect_openmp = "Not Available",
    nb_loops_80_if_clean = 8,
    speedup_if_fully_vectorised = 1.5671,
    nb_loops_80_if_fp_vect = 6,
    flow_complexity = 1.0975066520441,
    speedup_if_clean = 1.0374,
    profiled_time = 18.68,
    array_access_efficiency = 79.415858211233,
    crest_performance = "Not Implemented Yet",
    number_processes = 3,
    speedup_if_FP_only = 1.162,
    nb_threads = 15,
    application_time = 22.401306152344,
    compilation_options = "OK",
    innerloops_time = 64.42,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 12.81 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 12.03 seconds.",
  },
  colors = {
