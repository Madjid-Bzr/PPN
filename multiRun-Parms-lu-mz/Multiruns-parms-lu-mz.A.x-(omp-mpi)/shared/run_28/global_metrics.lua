_report = {
  metrics = {
    ...
    loops_time = 67.22,
    speedup_if_fp_vect = 1.2731,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.6035170307263,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.3558207347321,
    ...
    speedup_if_fully_vectorised = 1.6849,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.0856032296337,
    speedup_if_clean = 1.0373,
    profiled_time = 2.21,
    array_access_efficiency = 74.029067152701,
    crest_performance = "Not Implemented Yet",
    number_processes = 16,
    speedup_if_FP_only = 1.2217,
    nb_threads = 256,
    application_time = 4.140899181366,
    compilation_options = "OK",
    innerloops_time = 64.27,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 1.49 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 1.42 seconds.",
  },
  colors = {
