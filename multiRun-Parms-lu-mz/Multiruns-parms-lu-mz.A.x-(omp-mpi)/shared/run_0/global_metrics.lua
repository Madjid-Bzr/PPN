_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 5.5962,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.2851990813806,
    speedup_if_clean = 1.0621,
    profiled_time = 103.42,
    array_access_efficiency = 67.991988847522,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.3935,
    nb_threads = 1,
    application_time = 106.37408447266,
    compilation_options = "OK",
    innerloops_time = 94.94,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 102.32 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 98.19 seconds.",
  },
  colors = {
