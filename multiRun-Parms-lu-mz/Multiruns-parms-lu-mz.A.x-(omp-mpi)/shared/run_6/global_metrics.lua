_report = {
  metrics = {
    ...
    loops_time = 85.37,
    speedup_if_fp_vect = 1.5685,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.1583283742786,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0644734986005,
    ...
    speedup_if_fully_vectorised = 2.7139,
    nb_loops_80_if_fp_vect = 6,
    flow_complexity = 1.1930483011234,
    speedup_if_clean = 1.0505,
    profiled_time = 11.47,
    array_access_efficiency = 71.129058496692,
    crest_performance = "Not Implemented Yet",
    number_processes = 2,
    speedup_if_FP_only = 1.2882,
    nb_threads = 12,
    application_time = 12.23170375824,
    compilation_options = "OK",
    innerloops_time = 81.63,
  },
  help = {
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 9.36 seconds.",
  },
  colors = {
