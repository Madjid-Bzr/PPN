_report = {
  metrics = {
    ...
    loops_time = 75.65,
    speedup_if_fp_vect = 1.4246,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.3089042397584,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.1345586566826,
    nb_loops_80_if_FP_only = 17,
    GFlops = "Not Implemented Yet",
    speedup_if_L1 = "Not Available",
    GBs = "Not Implemented Yet",
    nb_loops_80_if_fully_vect = 19,
    nb_loops_80_if_perfect_openmp = "Not Available",
    nb_loops_80_if_clean = 8,
    speedup_if_fully_vectorised = 2.1056,
    nb_loops_80_if_fp_vect = 6,
    flow_complexity = 1.1500849425319,
    speedup_if_clean = 1.051,
    profiled_time = 19.67,
    array_access_efficiency = 72.805467424565,
    crest_performance = "Not Implemented Yet",
    number_processes = 3,
    speedup_if_FP_only = 1.2422,
    nb_threads = 9,
    application_time = 21.774267196655,
    compilation_options = "OK",
    innerloops_time = 70.79,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 14.88 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 13.92 seconds.",
  },
  colors = {
