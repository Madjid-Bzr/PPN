_report = {
  metrics = {
    ...
    loops_time = 72.77,
    speedup_if_fp_vect = 1.6467,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.335967106204,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.1753643629525,
    ...
    speedup_if_fully_vectorised = 2.6724,
    nb_loops_80_if_fp_vect = 6,
    flow_complexity = 1.1911682565098,
    speedup_if_clean = 1.0422,
    profiled_time = 27.82,
    array_access_efficiency = 68.928332050067,
    crest_performance = "Not Implemented Yet",
    number_processes = 5,
    speedup_if_FP_only = 1.2032,
    nb_threads = 5,
    application_time = 29.20263671875,
    compilation_options = "OK",
    innerloops_time = 67.82,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 20.24 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 18.87 seconds.",
  },
  colors = {
