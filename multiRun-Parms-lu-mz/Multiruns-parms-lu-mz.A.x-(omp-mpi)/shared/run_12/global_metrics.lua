_report = {
  metrics = {
    ...
    loops_time = 72.68,
    speedup_if_fp_vect = 1.3207,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.4081400069326,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.1627346056131,
    ...
    speedup_if_fully_vectorised = 1.7598,
    nb_loops_80_if_fp_vect = 6,
    flow_complexity = 1.1212072357592,
    speedup_if_clean = 1.0441,
    profiled_time = 19.09,
    array_access_efficiency = 76.842540900079,
    crest_performance = "Not Implemented Yet",
    number_processes = 3,
    speedup_if_FP_only = 1.1965,
    nb_threads = 12,
    application_time = 21.711273193359,
    compilation_options = "OK",
    innerloops_time = 68.14,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 13.87 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 13.01 seconds.",
  },
  colors = {
