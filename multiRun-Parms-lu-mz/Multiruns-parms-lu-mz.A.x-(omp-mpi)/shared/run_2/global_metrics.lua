_report = {
  metrics = {
    ...
    loops_time = 95.43,
    speedup_if_fp_vect = 1.7951,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0405537972503,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0198609807246,
    ...
    speedup_if_fully_vectorised = 4.3633,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.2492355154348,
    speedup_if_clean = 1.0601,
    profiled_time = 27.95,
    array_access_efficiency = 68.655311345332,
    crest_performance = "Not Implemented Yet",
    number_processes = 2,
    speedup_if_FP_only = 1.3718,
    nb_threads = 4,
    application_time = 29.110233306885,
    compilation_options = "OK",
    innerloops_time = 91.43,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 26.67 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 25.55 seconds.",
  },
  colors = {
