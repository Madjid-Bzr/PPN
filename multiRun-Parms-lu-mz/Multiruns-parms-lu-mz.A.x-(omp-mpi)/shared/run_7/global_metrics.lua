_report = {
  metrics = {
    ...
    loops_time = 85.96,
    speedup_if_fp_vect = 1.4849,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.1502567136247,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.069775105162,
    nb_loops_80_if_FP_only = 16,
    GFlops = "Not Implemented Yet",
    speedup_if_L1 = "Not Available",
    GBs = "Not Implemented Yet",
    nb_loops_80_if_fully_vect = 18,
    nb_loops_80_if_perfect_openmp = "Not Available",
    nb_loops_80_if_clean = 7,
    speedup_if_fully_vectorised = 2.3016,
    nb_loops_80_if_fp_vect = 6,
    flow_complexity = 1.1730836348424,
    speedup_if_clean = 1.0447,
    profiled_time = 10.96,
    array_access_efficiency = 74.56544316955,
    crest_performance = "Not Implemented Yet",
    number_processes = 2,
    speedup_if_FP_only = 1.2483,
    nb_threads = 14,
    application_time = 11.701580047607,
    compilation_options = "OK",
    innerloops_time = 82.65,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 9.42 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 9.06 seconds.",
  },
  colors = {
