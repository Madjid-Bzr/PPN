_report = {
  metrics = {
    ...
    loops_time = 89.35,
    speedup_if_fp_vect = 1.749,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0999546368202,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0655982925754,
    ...
    speedup_if_fully_vectorised = 3.7101,
    nb_loops_80_if_fp_vect = 5,
    flow_complexity = 1.0007964248914,
    speedup_if_clean = 1.0711,
    profiled_time = 6.91,
    array_access_efficiency = 54.531109700004,
    crest_performance = "Not Implemented Yet",
    number_processes = 16,
    speedup_if_FP_only = 1.4596,
    nb_threads = 16,
    application_time = 9.5289516448975,
    compilation_options = "OK",
    innerloops_time = 84.99,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 6.17 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 5.87 seconds.",
  },
  colors = {
