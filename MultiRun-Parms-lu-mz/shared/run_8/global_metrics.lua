_report = {
  metrics = {
    ...
    loops_time = 61.32,
    speedup_if_fp_vect = 1.085,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.8486094483784,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.1491773526524,
    nb_loops_80_if_FP_only = 21,
    GFlops = "Not Implemented Yet",
    speedup_if_L1 = "Not Available",
    GBs = "Not Implemented Yet",
    nb_loops_80_if_fully_vect = 17,
    nb_loops_80_if_perfect_openmp = "Not Available",
    nb_loops_80_if_clean = 8,
    speedup_if_fully_vectorised = 1.1612,
    nb_loops_80_if_fp_vect = 6,
    flow_complexity = 1.0302541057648,
    speedup_if_clean = 1.0125,
    profiled_time = 15.45,
    array_access_efficiency = 91.831449888934,
    crest_performance = "Not Implemented Yet",
    number_processes = 10,
    speedup_if_FP_only = 1.053,
    nb_threads = 80,
    application_time = 20.562810897827,
    compilation_options = "OK",
    innerloops_time = 59.61,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 9.47 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 9.21 seconds.",
  },
  colors = {
