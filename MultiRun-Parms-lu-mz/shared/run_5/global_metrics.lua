_report = {
  metrics = {
    ...
    loops_time = 78.68,
    speedup_if_fp_vect = 1.5468,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.2460741385734,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.1186933661483,
    ...
    speedup_if_fully_vectorised = 2.4522,
    nb_loops_80_if_fp_vect = 5,
    flow_complexity = 1.0012519727,
    speedup_if_clean = 1.0666,
    profiled_time = 11.27,
    array_access_efficiency = 58.15415346565,
    crest_performance = "Not Implemented Yet",
    number_processes = 6,
    speedup_if_FP_only = 1.3365,
    nb_threads = 12,
    application_time = 12.555598258972,
    compilation_options = "OK",
    innerloops_time = 72.49,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 8.87 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 8.17 seconds.",
  },
  colors = {
