_report = {
  metrics = {
    ...
    loops_time = 78.94,
    speedup_if_fp_vect = 1.5152,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.2391967416043,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.1236084928674,
    ...
    speedup_if_fully_vectorised = 2.4782,
    nb_loops_80_if_fp_vect = 6,
    flow_complexity = 1.1792833991079,
    speedup_if_clean = 1.0578,
    profiled_time = 12.54,
    array_access_efficiency = 70.279652404298,
    crest_performance = "Not Implemented Yet",
    number_processes = 6,
    speedup_if_FP_only = 1.2822,
    nb_threads = 12,
    application_time = 13.899013519287,
    compilation_options = "OK",
    innerloops_time = 73.27,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 9.90 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 9.19 seconds.",
  },
  colors = {
