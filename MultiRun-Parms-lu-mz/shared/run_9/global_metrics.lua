_report = {
  metrics = {
    ...
    loops_time = 90.82,
    speedup_if_fp_vect = 1.7429,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0842930123252,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0509336200997,
    ...
    speedup_if_fully_vectorised = 4.0105,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.2436662642605,
    speedup_if_clean = 1.0607,
    profiled_time = 7.74,
    array_access_efficiency = 67.744076417234,
    crest_performance = "Not Implemented Yet",
    number_processes = 16,
    speedup_if_FP_only = 1.3718,
    nb_threads = 16,
    application_time = 9.7528829574585,
    compilation_options = "OK",
    innerloops_time = 87.06,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 7.03 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 6.74 seconds.",
  },
  colors = {
