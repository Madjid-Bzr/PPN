_report = {
  metrics = {
    ...
    loops_time = 93.79,
    speedup_if_fp_vect = 1.853,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0625900779918,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0454281865922,
    ...
    speedup_if_fully_vectorised = 4.0937,
    nb_loops_80_if_fp_vect = 6,
    flow_complexity = 1.0006196972823,
    speedup_if_clean = 1.0695,
    profiled_time = 12.67,
    array_access_efficiency = 55.432921306128,
    crest_performance = "Not Implemented Yet",
    number_processes = 4,
    speedup_if_FP_only = 1.4433,
    nb_threads = 8,
    application_time = 13.538905143738,
    compilation_options = "OK",
    innerloops_time = 89.21,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 11.88 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 11.30 seconds.",
  },
  colors = {
