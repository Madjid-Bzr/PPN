_report = {
  metrics = {
    ...
    loops_time = 94.28,
    speedup_if_fp_vect = 1.7977,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0565092392364,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.043705498016,
    ...
    speedup_if_fully_vectorised = 4.2303,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.2470587364482,
    speedup_if_clean = 1.0582,
    profiled_time = 14.22,
    array_access_efficiency = 68.690529350436,
    crest_performance = "Not Implemented Yet",
    number_processes = 4,
    speedup_if_FP_only = 1.3572,
    nb_threads = 8,
    application_time = 15.113545417786,
    compilation_options = "OK",
    innerloops_time = 90.15,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 13.41 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 12.82 seconds.",
  },
  colors = {
