_report = {
  metrics = {
    ...
    loops_time = 91.85,
    speedup_if_fp_vect = 1.7453,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.086541363029,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0714492000231,
    ...
    speedup_if_fully_vectorised = 3.8458,
    nb_loops_80_if_fp_vect = 6,
    flow_complexity = 1.2380201453917,
    speedup_if_clean = 1.0567,
    profiled_time = 7.42,
    array_access_efficiency = 68.855335119544,
    crest_performance = "Not Implemented Yet",
    number_processes = 8,
    speedup_if_FP_only = 1.3466,
    nb_threads = 16,
    application_time = 8.807825088501,
    compilation_options = "OK",
    innerloops_time = 87.76,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 6.82 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 6.51 seconds.",
  },
  colors = {
