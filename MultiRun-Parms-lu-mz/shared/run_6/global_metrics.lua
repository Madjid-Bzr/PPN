_report = {
  metrics = {
    ...
    loops_time = 90.06,
    speedup_if_fp_vect = 1.7654,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.1092916407117,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0757320012784,
    ...
    speedup_if_fully_vectorised = 3.5502,
    nb_loops_80_if_fp_vect = 5,
    flow_complexity = 1.0008827126452,
    speedup_if_clean = 1.0665,
    profiled_time = 6.89,
    array_access_efficiency = 55.963646031076,
    crest_performance = "Not Implemented Yet",
    number_processes = 8,
    speedup_if_FP_only = 1.4178,
    nb_threads = 16,
    application_time = 7.990375995636,
    compilation_options = "OK",
    innerloops_time = 85.62,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 6.21 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 5.90 seconds.",
  },
  colors = {
