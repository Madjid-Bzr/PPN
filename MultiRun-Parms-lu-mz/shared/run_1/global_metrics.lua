_report = {
  metrics = {
    ...
    loops_time = 90.89,
    speedup_if_fp_vect = 1.6225,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0916510050617,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.063588129618,
    ...
    speedup_if_fully_vectorised = 3.0119,
    nb_loops_80_if_fp_vect = 6,
    flow_complexity = 1.2055036565592,
    speedup_if_clean = 1.0518,
    profiled_time = 16.13,
    array_access_efficiency = 71.647203541685,
    crest_performance = "Not Implemented Yet",
    number_processes = 2,
    speedup_if_FP_only = 1.3071,
    nb_threads = 8,
    application_time = 16.983480453491,
    compilation_options = "OK",
    innerloops_time = 87.18,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 14.66 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 14.06 seconds.",
  },
  colors = {
