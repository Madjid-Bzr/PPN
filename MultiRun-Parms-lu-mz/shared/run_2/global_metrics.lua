_report = {
  metrics = {
    ...
    loops_time = 72.24,
    speedup_if_fp_vect = 1.3175,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.4189988262132,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.1691804045364,
    ...
    speedup_if_fully_vectorised = 1.747,
    nb_loops_80_if_fp_vect = 6,
    flow_complexity = 1.1226567390268,
    speedup_if_clean = 1.0421,
    profiled_time = 19.26,
    array_access_efficiency = 77.061444964435,
    crest_performance = "Not Implemented Yet",
    number_processes = 3,
    speedup_if_FP_only = 1.1913,
    nb_threads = 12,
    application_time = 21.992853164673,
    compilation_options = "OK",
    innerloops_time = 67.85,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 13.91 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 13.07 seconds.",
  },
  colors = {
