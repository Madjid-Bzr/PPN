_report = {
  metrics = {
    ...
    loops_time = 71.24,
    speedup_if_fp_vect = 1.3062,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.4319652703305,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.1651216833933,
    ...
    speedup_if_fully_vectorised = 1.6866,
    nb_loops_80_if_fp_vect = 5,
    flow_complexity = 1.0020698426804,
    speedup_if_clean = 1.0493,
    profiled_time = 18.25,
    array_access_efficiency = 68.719485906614,
    crest_performance = "Not Implemented Yet",
    number_processes = 3,
    speedup_if_FP_only = 1.2254,
    nb_threads = 12,
    application_time = 21.386110305786,
    compilation_options = "OK",
    innerloops_time = 66.39,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 13.00 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 12.12 seconds.",
  },
  colors = {
