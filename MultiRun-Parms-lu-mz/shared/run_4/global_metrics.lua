_report = {
  metrics = {
    ...
    loops_time = 88.46,
    speedup_if_fp_vect = 1.644,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.1241189800568,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0937620092112,
    ...
    speedup_if_fully_vectorised = 2.8729,
    nb_loops_80_if_fp_vect = 5,
    flow_complexity = 1.0012559472177,
    speedup_if_clean = 1.0605,
    profiled_time = 7.4,
    array_access_efficiency = 59.377360114615,
    crest_performance = "Not Implemented Yet",
    number_processes = 4,
    speedup_if_FP_only = 1.3703,
    nb_threads = 16,
    application_time = 8.1381711959839,
    compilation_options = "OK",
    innerloops_time = 84.19,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 6.55 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 6.23 seconds.",
  },
  colors = {
