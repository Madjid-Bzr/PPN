_report = {
  metrics = {
    ...
    loops_time = 88.88,
    speedup_if_fp_vect = 1.6047,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.1233491905866,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0870418334511,
    ...
    speedup_if_fully_vectorised = 2.9024,
    nb_loops_80_if_fp_vect = 6,
    flow_complexity = 1.2005612007026,
    speedup_if_clean = 1.0517,
    profiled_time = 8.31,
    array_access_efficiency = 71.351001290368,
    crest_performance = "Not Implemented Yet",
    number_processes = 4,
    speedup_if_FP_only = 1.3019,
    nb_threads = 16,
    application_time = 9.0803241729736,
    compilation_options = "OK",
    innerloops_time = 85.08,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 7.39 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 7.07 seconds.",
  },
  colors = {
