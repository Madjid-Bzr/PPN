_report = {
  metrics = {
    ...
    loops_time = 62.64,
    speedup_if_fp_vect = 1.2496,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.7485004552516,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.4578181522456,
    ...
    speedup_if_fully_vectorised = 1.6097,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.0810046275744,
    speedup_if_clean = 1.0338,
    profiled_time = 2.42,
    array_access_efficiency = 74.374387283945,
    crest_performance = "Not Implemented Yet",
    number_processes = 16,
    speedup_if_FP_only = 1.2017,
    nb_threads = 256,
    application_time = 4.3875060081482,
    compilation_options = "OK",
    innerloops_time = 60.04,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 1.52 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 1.45 seconds.",
  },
  colors = {
