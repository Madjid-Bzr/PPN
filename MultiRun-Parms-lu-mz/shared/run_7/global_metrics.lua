_report = {
  metrics = {
    ...
    loops_time = 61.09,
    speedup_if_fp_vect = 1.2378,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.7838116105357,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.514369004581,
    nb_loops_80_if_FP_only = 18,
    ...
    nb_loops_80_if_clean = 10,
    speedup_if_fully_vectorised = 1.5945,
    nb_loops_80_if_fp_vect = 6,
    flow_complexity = 1.0013464032456,
    speedup_if_clean = 1.0391,
    profiled_time = 2.12,
    array_access_efficiency = 66.15775222965,
    crest_performance = "Not Implemented Yet",
    number_processes = 16,
    speedup_if_FP_only = 1.2362,
    nb_threads = 256,
    application_time = 4.0796689987183,
    compilation_options = "OK",
    innerloops_time = 58.25,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 1.30 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 1.23 seconds.",
  },
  colors = {
