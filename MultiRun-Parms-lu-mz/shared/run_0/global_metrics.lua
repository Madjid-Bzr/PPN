_report = {
  metrics = {
    ...
    nb_loops_80_if_fully_vect = 25,
    nb_loops_80_if_perfect_openmp = "Not Available",
    nb_loops_80_if_clean = 8,
    speedup_if_fully_vectorised = 5.3081,
    nb_loops_80_if_fp_vect = 6,
    flow_complexity = 1.0006198108955,
    speedup_if_clean = 1.0752,
    profiled_time = 91.93,
    array_access_efficiency = 54.517540612528,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.5064,
    nb_threads = 1,
    application_time = 94.973754882813,
    compilation_options = "OK",
    innerloops_time = 94.35,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 90.89 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 86.74 seconds.",
  },
  colors = {
