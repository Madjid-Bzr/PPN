_report = {
  metrics = {
    ...
    loops_time = 98.78,
    speedup_if_fp_vect = 1.8936,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0047221943133,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0047221943133,
    ...
    speedup_if_fully_vectorised = 5.5493,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.2830439733593,
    speedup_if_clean = 1.0617,
    profiled_time = 103.48,
    array_access_efficiency = 68.031114992827,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.3993,
    nb_threads = 1,
    application_time = 106.73188781738,
    compilation_options = "OK",
    innerloops_time = 95.05,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 102.22 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 98.36 seconds.",
  },
  colors = {
