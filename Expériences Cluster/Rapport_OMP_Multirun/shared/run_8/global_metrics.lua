_report = {
  metrics = {
    ...
    loops_time = 99.37,
    speedup_if_fp_vect = 1.0022,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0142309571959,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0046212577858,
    ...
    speedup_if_fully_vectorised = 1.0029,
    ...
    number_processes = 1,
    speedup_if_FP_only = 1.2629,
    nb_threads = 32,
    application_time = 5.7677369117737,
    compilation_options = "OK",
    innerloops_time = 98.9,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 5.42 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 5.39 seconds.",
  },
  colors = {
