...
multiruns_params = {
  ...
  {number_processes = 1,environment_variables = {{name = "OMP_NUM_THREADS", value = "20",},},name = "R20",},
  {number_processes = 1,environment_variables = {{name = "OMP_NUM_THREADS", value = "32",},},name = "R32",},
}
