_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 1.0027,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 131.97,
    array_access_efficiency = 100,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.2649,
    nb_threads = 1,
    application_time = 133.88650512695,
    compilation_options = "OK",
    innerloops_time = 99.5,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 131.89 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 131.31 seconds.",
  },
  colors = {
