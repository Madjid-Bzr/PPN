_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0065908338288,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0008006405124,
    ...
    speedup_if_fully_vectorised = 1.0039,
    ...
    number_processes = 1,
    speedup_if_FP_only = 1.2633,
    nb_threads = 12,
    application_time = 13.405427932739,
    compilation_options = "OK",
    innerloops_time = 99.01,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 13.02 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 12.94 seconds.",
  },
  colors = {
