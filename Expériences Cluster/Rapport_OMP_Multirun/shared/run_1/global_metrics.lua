_report = {
  metrics = {
    ...
    loops_time = 99.91,
    speedup_if_fp_vect = 1.0025,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.001915507058,
    ...
    speedup_if_fully_vectorised = 1.0033,
    ...
    nb_threads = 2,
    application_time = 76.15657043457,
    compilation_options = "OK",
    innerloops_time = 99.38,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 75.11 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 74.71 seconds.",
  },
  colors = {
