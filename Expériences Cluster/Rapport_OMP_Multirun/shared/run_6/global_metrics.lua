_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 1.0037,
    ...
    number_processes = 1,
    speedup_if_FP_only = 1.2634,
    nb_threads = 16,
    application_time = 10.878057479858,
    compilation_options = "OK",
    innerloops_time = 99.05,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 10.47 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 10.41 seconds.",
  },
  colors = {
