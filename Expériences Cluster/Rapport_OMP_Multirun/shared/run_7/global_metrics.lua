_report = {
  metrics = {
    ...
    loops_time = 99.68,
    speedup_if_fp_vect = 1.0016,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0105994200268,
    ...
    speedup_if_fully_vectorised = 1.0021,
    ...
    number_processes = 1,
    speedup_if_FP_only = 1.2644,
    nb_threads = 20,
    application_time = 7.9233288764954,
    compilation_options = "OK",
    innerloops_time = 99.34,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 7.64 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 7.61 seconds.",
  },
  colors = {
