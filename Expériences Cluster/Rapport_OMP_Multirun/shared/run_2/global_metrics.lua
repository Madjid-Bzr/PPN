_report = {
  metrics = {
    ...
    loops_time = 99.86,
    speedup_if_fp_vect = 1.0032,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0017946433574,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0009008107297,
    ...
    number_processes = 1,
    speedup_if_FP_only = 1.2638,
    nb_threads = 3,
    application_time = 51.021102905273,
    compilation_options = "OK",
    innerloops_time = 99.17,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 50.29 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 49.94 seconds.",
  },
  colors = {
