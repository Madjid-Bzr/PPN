_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0023689140708,
    ...
    number_processes = 1,
    speedup_if_FP_only = 1.2652,
    nb_threads = 4,
    application_time = 38.108421325684,
    compilation_options = "OK",
    innerloops_time = 99.58,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 37.50 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 37.39 seconds.",
  },
  colors = {
