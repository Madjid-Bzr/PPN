_report = {
  metrics = {
    ...
    loops_time = 99.81,
    speedup_if_fp_vect = 1.004,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0037152197384,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.001001001001,
    ...
    speedup_if_fully_vectorised = 1.0053,
    ...
    number_processes = 1,
    speedup_if_FP_only = 1.263,
    nb_threads = 8,
    application_time = 20.035266876221,
    compilation_options = "OK",
    innerloops_time = 98.96,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 19.63 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 19.47 seconds.",
  },
  colors = {
