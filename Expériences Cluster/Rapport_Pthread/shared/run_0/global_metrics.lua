_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 1.0014,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.0004,
    profiled_time = 12.74,
    array_access_efficiency = 99.994975379359,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.2681,
    nb_threads = 11,
    application_time = 129.25350952148,
    compilation_options = "OK",
    innerloops_time = 99.51,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 12.73 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 12.68 seconds.",
  },
  colors = {
