_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.3779612047447,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.1844407206836,
    ...
    speedup_if_fully_vectorised = 1.0555,
    nb_loops_80_if_fp_vect = 3,
    flow_complexity = 1,
    speedup_if_clean = 1.014,
    profiled_time = 0.61,
    array_access_efficiency = 99.539512774807,
    crest_performance = "Not Implemented Yet",
    number_processes = 20,
    speedup_if_FP_only = 1.142,
    nb_threads = 20,
    application_time = 3.4143269062042,
    compilation_options = "OK",
    innerloops_time = 50.49,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 0.32 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.31 seconds.",
  },
  colors = {
