_report = {
  metrics = {
    ...
    loops_time = 30.9,
    speedup_if_fp_vect = 1.0353,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.8598680121417,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.3512637018139,
    ...
    speedup_if_fully_vectorised = 1.0528,
    nb_loops_80_if_fp_vect = 3,
    flow_complexity = 1,
    speedup_if_clean = 1.0137,
    profiled_time = 0.5,
    array_access_efficiency = 99.028875902372,
    crest_performance = "Not Implemented Yet",
    number_processes = 32,
    speedup_if_FP_only = 1.0857,
    nb_threads = 32,
    application_time = 4.8409090042114,
    compilation_options = "OK",
    innerloops_time = 29.09,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 0.15 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.15 seconds.",
  },
  colors = {
