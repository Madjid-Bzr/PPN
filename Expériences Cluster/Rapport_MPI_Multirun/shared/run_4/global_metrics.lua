_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0745984074784,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0319988127447,
    ...
    speedup_if_fully_vectorised = 1.0184,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1,
    speedup_if_clean = 1.0041,
    profiled_time = 2.26,
    array_access_efficiency = 99.976325757576,
    crest_performance = "Not Implemented Yet",
    number_processes = 8,
    speedup_if_FP_only = 1.2251,
    nb_threads = 8,
    application_time = 3.4593210220337,
    compilation_options = "OK",
    innerloops_time = 84.48,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 1.94 seconds.",
