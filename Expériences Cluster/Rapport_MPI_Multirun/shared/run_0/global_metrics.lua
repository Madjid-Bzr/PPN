_report = {
  metrics = {
    ...
    profiled_time = 134.17,
    array_access_efficiency = 99.997477550197,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.2638,
    nb_threads = 1,
    application_time = 136.63557434082,
    compilation_options = "OK",
    innerloops_time = 99.11,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 134.02 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 132.98 seconds.",
  },
  colors = {
