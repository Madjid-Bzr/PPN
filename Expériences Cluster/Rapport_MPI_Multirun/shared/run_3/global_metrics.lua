_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.02872924242,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0067164067968,
    ...
    speedup_if_fully_vectorised = 1.0136,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1,
    speedup_if_clean = 1.0015,
    profiled_time = 6.76,
    array_access_efficiency = 99.902188854817,
    crest_performance = "Not Implemented Yet",
    number_processes = 4,
    speedup_if_FP_only = 1.2511,
    nb_threads = 4,
    application_time = 7.3888239860535,
    compilation_options = "OK",
    innerloops_time = 94.57,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 6.47 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 6.39 seconds.",
  },
  colors = {
