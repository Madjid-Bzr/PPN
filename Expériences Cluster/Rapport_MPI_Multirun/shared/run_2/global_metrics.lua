_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 1.0067,
    nb_loops_80_if_fp_vect = 3,
    flow_complexity = 1,
    speedup_if_clean = 1.0008,
    profiled_time = 11.63,
    array_access_efficiency = 99.916857202245,
    crest_performance = "Not Implemented Yet",
    number_processes = 3,
    speedup_if_FP_only = 1.2554,
    nb_threads = 3,
    application_time = 12.160443305969,
    compilation_options = "OK",
    innerloops_time = 96.22,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 11.23 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 11.19 seconds.",
  },
  colors = {
