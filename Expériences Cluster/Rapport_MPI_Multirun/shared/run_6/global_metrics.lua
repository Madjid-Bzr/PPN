_report = {
  metrics = {
    ...
    loops_time = 59.95,
    speedup_if_fp_vect = 1.0373,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.3191557190631,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.206601276662,
    ...
    speedup_if_fully_vectorised = 1.049,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1,
    speedup_if_clean = 1.0096,
    profiled_time = 0.93,
    array_access_efficiency = 99.184179053477,
    crest_performance = "Not Implemented Yet",
    number_processes = 16,
    speedup_if_FP_only = 1.1531,
    nb_threads = 16,
    application_time = 3.2555449008942,
    compilation_options = "OK",
    innerloops_time = 58.53,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 0.56 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.54 seconds.",
  },
  colors = {
