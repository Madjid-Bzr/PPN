_report = {
  metrics = {
    ...
    loops_time = 75.06,
    speedup_if_fp_vect = 1.0372,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.1555624105258,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0624468776561,
    ...
    speedup_if_fully_vectorised = 1.0496,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1,
    speedup_if_clean = 1.0088,
    profiled_time = 1.19,
    array_access_efficiency = 99.182321935397,
    crest_performance = "Not Implemented Yet",
    number_processes = 12,
    speedup_if_FP_only = 1.1969,
    nb_threads = 12,
    application_time = 2.9465069770813,
    compilation_options = "OK",
    innerloops_time = 73.99,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 0.89 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.88 seconds.",
  },
  colors = {
