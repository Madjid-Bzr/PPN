_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0044782640203,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0014186067586,
    ...
    speedup_if_fully_vectorised = 1.0018,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1,
    speedup_if_clean = 1.0002,
    profiled_time = 23.98,
    array_access_efficiency = 99.992420414351,
    crest_performance = "Not Implemented Yet",
    number_processes = 2,
    speedup_if_FP_only = 1.2637,
    nb_threads = 2,
    application_time = 24.522169113159,
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 23.77 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 23.73 seconds.",
  },
  colors = {
