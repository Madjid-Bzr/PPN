_report = {
  metrics = {
    ...
    number_processes = 1,
    speedup_if_FP_only = 1.2512,
    nb_threads = 256,
    application_time = 12.67381477356,
    compilation_options = "OK",
    innerloops_time = 95.33,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 9.31 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 9.25 seconds.",
  },
  colors = {
