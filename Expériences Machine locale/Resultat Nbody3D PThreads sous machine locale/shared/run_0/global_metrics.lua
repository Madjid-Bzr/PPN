_report = {
  metrics = {
    ...
    number_processes = 1,
    speedup_if_FP_only = 1.0001,
    nb_threads = 82,
    application_time = 7.8666281700134,
    compilation_options = "OK",
    innerloops_time = 99.85,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 0.68 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.68 seconds.",
  },
  colors = {
