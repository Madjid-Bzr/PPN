_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 1.0003,
    ...
    nb_threads = 8,
    application_time = 64.906692504883,
    compilation_options = "OK",
    innerloops_time = 99.71,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 61.76 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 61.73 seconds.",
  },
  colors = {
