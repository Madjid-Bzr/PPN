_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 13.692873628612,
    speedup_if_perfect_MPI_OMP_PTHREAD = 6.0753341433779,
    ...
    speedup_if_fully_vectorised = 1.0708,
    ...
    nb_threads = 8,
    application_time = 10.59,
    compilation_options = "Not Available",
    innerloops_time = 7.02,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 0.752949 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.743418 seconds.",
  },
  colors = {
