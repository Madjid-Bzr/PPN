_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 16.07075253119,
    speedup_if_perfect_MPI_OMP_PTHREAD = 6.5359477124183,
    ...
    speedup_if_fully_vectorised = 1.068,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1.0001862224429,
    speedup_if_clean = 1,
    profiled_time = 10.57,
    ...
    nb_threads = 9,
    application_time = 10.57,
    compilation_options = "Not Available",
    innerloops_time = 6.82,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 0.722988 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.720874 seconds.",
  },
  colors = {
