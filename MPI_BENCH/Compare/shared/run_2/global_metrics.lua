_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 14.177662384711,
    speedup_if_perfect_MPI_OMP_PTHREAD = 6.0790273556231,
    ...
    speedup_if_fully_vectorised = 1.0767,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1.0000931905018,
    speedup_if_clean = 1,
    profiled_time = 10.41,
    array_access_efficiency = 83.311316600616,
    crest_performance = "Not Implemented Yet",
    number_processes = 4,
    speedup_if_FP_only = 1,
    nb_threads = 8,
    application_time = 10.41,
    compilation_options = "Not Available",
    innerloops_time = 7.58,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 0.797406 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.789078 seconds.",
  },
  colors = {
