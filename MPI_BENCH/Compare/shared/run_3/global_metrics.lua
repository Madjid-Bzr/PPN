_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 16.8506461999,
    speedup_if_perfect_MPI_OMP_PTHREAD = 6.1978307592343,
    ...
    flow_complexity = 1.0000930146033,
    speedup_if_clean = 1,
    profiled_time = 10.54,
    array_access_efficiency = 83.311199645861,
    crest_performance = "Not Implemented Yet",
    number_processes = 4,
    speedup_if_FP_only = 1,
    nb_threads = 10,
    application_time = 10.54,
    compilation_options = "Not Available",
    innerloops_time = 7.54,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 0.807364 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.794716 seconds.",
  },
  colors = {
