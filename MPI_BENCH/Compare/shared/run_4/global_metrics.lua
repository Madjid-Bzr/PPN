_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 13.117665844321,
    speedup_if_perfect_MPI_OMP_PTHREAD = 7.1123510010755,
    ...
    speedup_if_fully_vectorised = 1.0734,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1.0003728662501,
    speedup_if_clean = 1,
    profiled_time = 10.31,
    array_access_efficiency = 83.310313075506,
    crest_performance = "Not Implemented Yet",
    number_processes = 4,
    speedup_if_FP_only = 1,
    nb_threads = 7,
    application_time = 10.31,
    compilation_options = "Not Available",
    innerloops_time = 7.28,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 0.757785 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.750568 seconds.",
  },
  colors = {
