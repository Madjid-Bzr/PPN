  ...
  paths = {
    {
      ...
      expert = {
        ...
        {
          title = "Back-end",
          txt = "       | P0    | P1    | P2    | P3    | P4    | P5    | P6    | P7\n----------------------------------------------------------------------\nuops   | 20.75 | 20.75 | 13.00 | 13.00 | 18.00 | 20.75 | 20.75 | 13.00\ncycles | 20.75 | 20.75 | 13.00 | 13.00 | 18.00 | 20.75 | 20.75 | 13.00\n\nCycles executing div or sqrt instructions: 37.00-99.00\n",
        },
        {
        ...
        },
        {
          ...
          txt = "Assuming all data fit into the L1 cache, each call to the function takes 99.00 cycles. At this rate:\n - 1% of peak load performance is reached (0.81 out of 64.00 bytes loaded per cycle (GB/s @ 1GHz))\n - 1% of peak store performance is reached (0.48 out of 32.00 bytes stored per cycle (GB/s @ 1GHz))\n",
        },
        {
