_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 9.5375247912482,
    speedup_if_perfect_MPI_OMP_PTHREAD = 4.420866489832,
    ...
    speedup_if_fully_vectorised = 1.0256,
    ...
    nb_threads = 4,
    application_time = 7.55,
    compilation_options = "OK",
    innerloops_time = 2.79,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 0.215175 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.210645 seconds.",
  },
  colors = {
