_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 14.9131821734,
    speedup_if_perfect_MPI_OMP_PTHREAD = 5.8309037900875,
    ...
    nb_threads = 8,
    application_time = 7.39,
    compilation_options = "OK",
    innerloops_time = 2.83,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 0.210615 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.209137 seconds.",
  },
  colors = {
