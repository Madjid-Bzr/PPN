_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 16.690170912525,
    speedup_if_perfect_MPI_OMP_PTHREAD = 6.514657980456,
    ...
    speedup_if_fully_vectorised = 1.0268,
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 0.244283 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.23693 seconds.",
  },
  colors = {
