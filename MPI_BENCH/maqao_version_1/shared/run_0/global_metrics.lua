_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 15.785349344904,
    speedup_if_perfect_MPI_OMP_PTHREAD = 7.2882853839655,
    ...
    speedup_if_fully_vectorised = 1.0603,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1.0001860465116,
    speedup_if_clean = 1,
    profiled_time = 10.49,
    ...
    nb_threads = 8,
    application_time = 10.49,
    compilation_options = "Not Available",
    innerloops_time = 6.09,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 0.640939 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.638841 seconds.",
  },
  colors = {
