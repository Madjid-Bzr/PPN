_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 20.350383132988,
    speedup_if_perfect_MPI_OMP_PTHREAD = 7.6032614097594,
    ...
    speedup_if_fully_vectorised = 1.0267,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 7.42,
    array_access_efficiency = 50.341296928328,
    crest_performance = "Not Implemented Yet",
    number_processes = 4,
    speedup_if_FP_only = 1,
    nb_threads = 10,
    application_time = 7.42,
    compilation_options = "OK",
    innerloops_time = 2.93,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 0.221116 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.217406 seconds.",
  },
  colors = {
