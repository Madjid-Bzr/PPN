_report = {
  metrics = {
    ...
    loops_time = 55.73,
    speedup_if_fp_vect = 1.0594,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0167768174886,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.002305302195,
    ...
    speedup_if_fully_vectorised = 1.4643,
    nb_loops_80_if_fp_vect = 7,
    flow_complexity = 1.0071927639493,
    speedup_if_clean = 1.0088,
    profiled_time = 22.21,
    array_access_efficiency = 87.935935052136,
    crest_performance = "Not Implemented Yet",
    number_processes = 2,
    speedup_if_FP_only = 1.1982,
    nb_threads = 2,
    application_time = 22.209247589111,
    compilation_options = "OK",
    innerloops_time = 52.99,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 12.38 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 11.77 seconds.",
  },
  colors = {
