_report = {
  metrics = {
    ...
    loops_time = 45.31,
    speedup_if_fp_vect = 1.3589,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 2.0149066767638,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.8001800180018,
    ...
    speedup_if_fully_vectorised = 1.5487,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1.249104548177,
    speedup_if_clean = 1.204,
    profiled_time = 1.04,
    array_access_efficiency = 50.917818740399,
    crest_performance = "Not Implemented Yet",
    number_processes = 16,
    speedup_if_FP_only = 1.3797,
    nb_threads = 16,
    application_time = 3.3462359905243,
    compilation_options = "OK",
    innerloops_time = 44.48,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 0.47 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.46 seconds.",
  },
  colors = {
