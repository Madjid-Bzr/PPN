_report = {
  metrics = {
    ...
    loops_time = 36.77,
    speedup_if_fp_vect = 1.2727,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 2.4690255990473,
    speedup_if_perfect_MPI_OMP_PTHREAD = 2.1668833550022,
    ...
    speedup_if_fully_vectorised = 1.4045,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1.1977494288232,
    speedup_if_clean = 1.1622,
    profiled_time = 1.04,
    array_access_efficiency = 50.58207217695,
    crest_performance = "Not Implemented Yet",
    number_processes = 20,
    speedup_if_FP_only = 1.2912,
    nb_threads = 20,
    application_time = 3.8936009407043,
    compilation_options = "OK",
    innerloops_time = 36.01,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 0.38 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.37 seconds.",
  },
  colors = {
