_report = {
  metrics = {
    ...
    loops_time = 98.89,
    speedup_if_fp_vect = 2.3529,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0043185698504,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0043185698504,
    ...
    speedup_if_fully_vectorised = 4.3722,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1.7834186649625,
    speedup_if_clean = 1.5795,
    profiled_time = 6.85,
    array_access_efficiency = 50.46257285303,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.5009,
    nb_threads = 1,
    application_time = 7.603768825531,
    compilation_options = "OK",
    innerloops_time = 97.65,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 6.77 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 6.69 seconds.",
  },
  colors = {
