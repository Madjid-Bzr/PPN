_report = {
  metrics = {
    ...
    loops_time = 93.92,
    speedup_if_fp_vect = 2.2073,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0867435496453,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0765878227238,
    ...
    speedup_if_fully_vectorised = 3.7419,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1.7173843663639,
    speedup_if_clean = 1.5358,
    profiled_time = 3.73,
    array_access_efficiency = 50.405963979923,
    crest_performance = "Not Implemented Yet",
    number_processes = 2,
    speedup_if_FP_only = 2.3309,
    nb_threads = 2,
    application_time = 4.2813491821289,
    compilation_options = "OK",
    innerloops_time = 92.81,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 3.50 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 3.46 seconds.",
  },
  colors = {
