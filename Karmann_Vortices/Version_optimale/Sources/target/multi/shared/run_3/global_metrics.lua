_report = {
  metrics = {
    ...
    loops_time = 66.4,
    speedup_if_fp_vect = 1.6327,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.4728318554319,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.3430029546065,
    ...
    speedup_if_fully_vectorised = 2.0826,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1.4253765488498,
    speedup_if_clean = 1.3344,
    profiled_time = 1.61,
    array_access_efficiency = 50.769884251885,
    crest_performance = "Not Implemented Yet",
    number_processes = 8,
    speedup_if_FP_only = 1.6822,
    nb_threads = 8,
    application_time = 2.8550319671631,
    compilation_options = "OK",
    innerloops_time = 65.48,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 1.07 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 1.05 seconds.",
  },
  colors = {
