_report = {
  metrics = {
    ...
    loops_time = 41.55,
    speedup_if_fp_vect = 1.3187,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 2.1632331023573,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.9167864658208,
    ...
    speedup_if_fully_vectorised = 1.4821,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1.2283998679061,
    speedup_if_clean = 1.187,
    profiled_time = 0.92,
    array_access_efficiency = 50.784715114295,
    crest_performance = "Not Implemented Yet",
    number_processes = 20,
    speedup_if_FP_only = 1.3408,
    nb_threads = 20,
    application_time = 3.823814868927,
    compilation_options = "OK",
    innerloops_time = 40.78,
  },
  help = {
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.38 seconds.",
  },
  colors = {
