_report = {
  metrics = {
    ...
    loops_time = 98.89,
    speedup_if_fp_vect = 2.3388,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0036130068246,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0036130068246,
    ...
    speedup_if_fully_vectorised = 4.3872,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1.7652380497062,
    speedup_if_clean = 1.5802,
    profiled_time = 6.86,
    array_access_efficiency = 50.414641876188,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.503,
    nb_threads = 1,
    application_time = 7.6287980079651,
    compilation_options = "OK",
    innerloops_time = 96.63,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 6.78 seconds.",
