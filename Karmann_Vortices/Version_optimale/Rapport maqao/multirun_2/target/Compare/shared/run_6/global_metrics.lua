_report = {
  metrics = {
    ...
    loops_time = 23.2,
    speedup_if_fp_vect = 1.1573,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 3.640313478091,
    speedup_if_perfect_MPI_OMP_PTHREAD = 2.0208179703897,
    ...
    speedup_if_fully_vectorised = 1.2235,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1.1213263945656,
    speedup_if_clean = 1.0996,
    profiled_time = 1.14,
    array_access_efficiency = 50.625996810207,
    crest_performance = "Not Implemented Yet",
    number_processes = 32,
    speedup_if_FP_only = 1.1684,
    nb_threads = 32,
    application_time = 5.5968689918518,
    compilation_options = "OK",
    innerloops_time = 22.79,
  },
  help = {
