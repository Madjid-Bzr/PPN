_report = {
  metrics = {
    ...
    loops_time = 71.32,
    speedup_if_fp_vect = 1.7115,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.3536209135328,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.2080483219329,
    ...
    speedup_if_fully_vectorised = 2.2655,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1.4773132694494,
    speedup_if_clean = 1.3733,
    profiled_time = 1.51,
    array_access_efficiency = 50.681294459473,
    crest_performance = "Not Implemented Yet",
    number_processes = 8,
    speedup_if_FP_only = 1.7817,
    nb_threads = 8,
    application_time = 2.7427599430084,
    compilation_options = "OK",
    innerloops_time = 70.18,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 1.08 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 1.06 seconds.",
  },
  colors = {
