_report = {
  metrics = {
    ...
    loops_time = 50.9,
    speedup_if_fp_vect = 1.4228,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.8386717435325,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.6788566256442,
    ...
    speedup_if_fully_vectorised = 1.6637,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1.2979149645053,
    speedup_if_clean = 1.2408,
    profiled_time = 1.15,
    array_access_efficiency = 50.676246830093,
    crest_performance = "Not Implemented Yet",
    number_processes = 16,
    speedup_if_FP_only = 1.4556,
    nb_threads = 16,
    application_time = 3.463436126709,
    compilation_options = "OK",
    innerloops_time = 49.82,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 0.59 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.57 seconds.",
  },
  colors = {
