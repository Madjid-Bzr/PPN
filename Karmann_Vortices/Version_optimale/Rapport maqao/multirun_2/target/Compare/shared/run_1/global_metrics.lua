_report = {
  metrics = {
    ...
    loops_time = 93.37,
    speedup_if_fp_vect = 2.1909,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0873416668015,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0763703522011,
    ...
    speedup_if_fully_vectorised = 3.6812,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1.6998544357985,
    speedup_if_clean = 1.5278,
    profiled_time = 3.73,
    array_access_efficiency = 50.409043581734,
    crest_performance = "Not Implemented Yet",
    number_processes = 2,
    speedup_if_FP_only = 2.2991,
    nb_threads = 2,
    application_time = 4.2686791419983,
    compilation_options = "OK",
    innerloops_time = 91.85,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 3.48 seconds.",
