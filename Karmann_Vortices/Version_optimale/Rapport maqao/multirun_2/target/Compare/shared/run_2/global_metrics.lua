_report = {
  metrics = {
    ...
    loops_time = 73.99,
    speedup_if_fp_vect = 1.7595,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.4014778397312,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.3488562929531,
    ...
    speedup_if_fully_vectorised = 2.3749,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1.4942021222153,
    speedup_if_clean = 1.3857,
    profiled_time = 2.63,
    array_access_efficiency = 50.636524314512,
    crest_performance = "Not Implemented Yet",
    number_processes = 4,
    speedup_if_FP_only = 1.8215,
    nb_threads = 4,
    application_time = 3.3042268753052,
    compilation_options = "OK",
    innerloops_time = 72.67,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 1.95 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 1.91 seconds.",
  },
  colors = {
