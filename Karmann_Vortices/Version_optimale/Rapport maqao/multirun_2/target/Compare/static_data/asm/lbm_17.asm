...
0x3a90;/users/user2207/lbm_opt/include/lbm_struct.h:148;MOV	%R12D,%ECX;
0x3a93;/users/user2207/lbm_opt/src/lbm_phys.c:191;MOV	$0x1,%EAX;
0x3a98;/users/user2207/lbm_opt/include/lbm_struct.h:148;IMUL	%R8D,%ECX;
0x3a9c;/users/user2207/lbm_opt/include/lbm_struct.h:148;TEST	$0x1,%R9B;
0x3aa0;/users/user2207/lbm_opt/include/lbm_struct.h:148;JNE	3b13 <special_cells._omp_fn.0+0x163>;
0x3aa2;/users/user2207/lbm_opt/include/lbm_struct.h:148;LEA	0x1(%RCX),%EAX;
0x3aa5;/users/user2207/lbm_opt/src/lbm_phys.c:192;MOV	(%RSI,%RAX,4),%EDX;
0x3aa8;/users/user2207/lbm_opt/src/lbm_phys.c:192;CMP	$0x2,%EDX;
0x3aab;/users/user2207/lbm_opt/src/lbm_phys.c:192;JE	3e50 <special_cells._omp_fn.0+0x4a0>;
0x3ab1;/users/user2207/lbm_opt/src/lbm_phys.c:192;CMP	$0x3,%EDX;
0x3ab4;/users/user2207/lbm_opt/src/lbm_phys.c:192;JE	3e08 <special_cells._omp_fn.0+0x458>;
0x3aba;/users/user2207/lbm_opt/src/lbm_phys.c:192;CMP	$0x1,%EDX;
0x3abd;/users/user2207/lbm_opt/src/lbm_phys.c:192;JE	3dc8 <special_cells._omp_fn.0+0x418>;
0x3ac3;/users/user2207/lbm_opt/src/lbm_phys.c:191;MOV	$0x2,%EAX;
0x3ac8;/users/user2207/lbm_opt/src/lbm_phys.c:191;CMP	%R9,%RAX;
0x3acb;/users/user2207/lbm_opt/src/lbm_phys.c:191;JNE	3b13 <special_cells._omp_fn.0+0x163>;
0x3acd;/users/user2207/lbm_opt/src/lbm_phys.c:191;JMP	3c27 <special_cells._omp_fn.0+0x277>;
...
0x3c27;/users/user2207/lbm_opt/src/lbm_phys.c:191;LEA	0x1(%R8),%R8;
0x3c2b;/users/user2207/lbm_opt/src/lbm_phys.c:191;LEA	(%RDI,%RBP,1),%EDI;
0x3c2e;/users/user2207/lbm_opt/src/lbm_phys.c:191;CMP	%R8,%R10;
0x3c31;/users/user2207/lbm_opt/src/lbm_phys.c:191;JA	3a90 <special_cells._omp_fn.0+0xe0>;
...
0x3dc8;/users/user2207/lbm_opt/include/lbm_struct.h:130;MOV	(%RBX),%RDX;
0x3dcb;/users/user2207/lbm_opt/include/lbm_struct.h:130;LEA	0x9(%RDI),%EAX;
0x3dce;/users/user2207/lbm_opt/include/lbm_struct.h:130;LEA	(%RDX,%RAX,8),%R13;
0x3dd2;/users/user2207/lbm_opt/src/lbm_phys.c:123;VMOVUPD	0x8(%R13),%XMM1;
0x3dd8;/users/user2207/lbm_opt/src/lbm_phys.c:123;VMOVUPD	0x28(%R13),%XMM10;
0x3dde;/users/user2207/lbm_opt/src/lbm_phys.c:129;VMOVUPD	0x18(%R13),%XMM15;
0x3de4;/users/user2207/lbm_opt/src/lbm_phys.c:129;VMOVUPD	0x38(%R13),%XMM2;
0x3dea;/users/user2207/lbm_opt/src/lbm_phys.c:129;VMOVUPD	%XMM15,0x8(%R13);
0x3df0;/users/user2207/lbm_opt/src/lbm_phys.c:129;VMOVUPD	%XMM1,0x18(%R13);
0x3df6;/users/user2207/lbm_opt/src/lbm_phys.c:129;VMOVUPD	%XMM2,0x28(%R13);
0x3dfc;/users/user2207/lbm_opt/src/lbm_phys.c:129;VMOVUPD	%XMM10,0x38(%R13);
0x3e02;/users/user2207/lbm_opt/src/lbm_phys.c:129;JMP	3ac3 <special_cells._omp_fn.0+0x113>;
0x3e08;/users/user2207/lbm_opt/include/lbm_struct.h:130;MOV	(%RBX),%RDX;
0x3e0b;/users/user2207/lbm_opt/include/lbm_struct.h:130;LEA	0x9(%RDI),%EAX;
0x3e0e;/users/user2207/lbm_opt/include/lbm_struct.h:130;LEA	(%RDX,%RAX,8),%R13;
0x3e12;/users/user2207/lbm_opt/src/lbm_phys.c:179;VMOVSD	0x20(%R13),%XMM12;
0x3e18;/users/user2207/lbm_opt/src/lbm_phys.c:179;VMOVSD	0x10(%R13),%XMM0;
0x3e1e;/users/user2207/lbm_opt/src/lbm_phys.c:179;VSUBSD	%XMM0,%XMM12,%XMM13;
0x3e22;/users/user2207/lbm_opt/src/lbm_phys.c:178;VMOVSD	0x8(%R13),%XMM11;
0x3e28;/users/user2207/lbm_opt/src/lbm_phys.c:180;VSUBSD	%XMM12,%XMM0,%XMM14;
0x3e2d;/users/user2207/lbm_opt/src/lbm_phys.c:178;VMOVSD	%XMM11,0x18(%R13);
0x3e33;/users/user2207/lbm_opt/src/lbm_phys.c:179;VFMADD213SD	0x40(%R13),%XMM4,%XMM13;
0x3e39;/users/user2207/lbm_opt/src/lbm_phys.c:179;VMOVSD	%XMM13,0x30(%R13);
0x3e3f;/users/user2207/lbm_opt/src/lbm_phys.c:180;VFMADD213SD	0x28(%R13),%XMM4,%XMM14;
0x3e45;/users/user2207/lbm_opt/src/lbm_phys.c:180;VMOVSD	%XMM14,0x38(%R13);
0x3e4b;/users/user2207/lbm_opt/src/lbm_phys.c:180;JMP	3ac3 <special_cells._omp_fn.0+0x113>;
0x3e50;/users/user2207/lbm_opt/include/lbm_struct.h:130;MOV	(%RBX),%R13;
0x3e53;/users/user2207/lbm_opt/include/lbm_struct.h:130;LEA	0x9(%RDI),%EAX;
0x3e56;/users/user2207/lbm_opt/include/lbm_struct.h:130;SAL	$0x3,%RAX;
0x3e5a;/users/user2207/lbm_opt/include/lbm_struct.h:130;ADD	%R13,%RAX;
0x3e5d;/users/user2207/lbm_opt/src/lbm_phys.c:200;MOV	0x4(%R11),%R13D;
0x3e61;/users/user2207/lbm_opt/src/lbm_phys.c:162;VMOVSD	0x18(%RAX),%XMM0;
0x3e66;/users/user2207/lbm_opt/src/lbm_phys.c:162;VMOVSD	0x30(%RAX),%XMM12;
0x3e6b;/users/user2207/lbm_opt/src/lbm_phys.c:141;VCVTSI2SD	%R13,%XMM1,%XMM1;
0x3e70;/users/user2207/lbm_opt/src/lbm_phys.c:162;VMOVSD	0x38(%RAX),%XMM13;
0x3e75;/users/user2207/lbm_opt/src/lbm_phys.c:162;VMOVSD	0x20(%RAX),%XMM11;
0x3e7a;/users/user2207/lbm_opt/src/lbm_phys.c:166;VMOVSD	%XMM0,0x8(%RAX);
0x3e7f;/users/user2207/lbm_opt/src/lbm_phys.c:143;VSUBSD	%XMM1,%XMM5,%XMM2;
0x3e83;/users/user2207/lbm_opt/src/lbm_phys.c:145;VMULSD	%XMM1,%XMM2,%XMM10;
0x3e87;/users/user2207/lbm_opt/src/lbm_phys.c:162;VADDSD	%XMM12,%XMM0,%XMM1;
0x3e8c;/users/user2207/lbm_opt/src/lbm_phys.c:162;VMOVSD	0x10(%RAX),%XMM2;
0x3e91;/users/user2207/lbm_opt/src/lbm_phys.c:162;VADDSD	(%RAX),%XMM2,%XMM14;
0x3e95;/users/user2207/lbm_opt/src/lbm_phys.c:145;VMULSD	%XMM6,%XMM10,%XMM15;
0x3e99;/users/user2207/lbm_opt/src/lbm_phys.c:162;VADDSD	%XMM13,%XMM1,%XMM10;
0x3e9e;/users/user2207/lbm_opt/src/lbm_phys.c:162;VFMADD132SD	%XMM9,%XMM11,%XMM10;
0x3ea3;/users/user2207/lbm_opt/src/lbm_phys.c:162;VADDSD	%XMM14,%XMM10,%XMM1;
0x3ea8;/users/user2207/lbm_opt/src/lbm_phys.c:167;VSUBSD	%XMM2,%XMM11,%XMM10;
0x3eac;/users/user2207/lbm_opt/src/lbm_phys.c:163;VSUBSD	%XMM15,%XMM8,%XMM14;
0x3eb1;/users/user2207/lbm_opt/src/lbm_phys.c:163;VMULSD	%XMM7,%XMM15,%XMM15;
0x3eb5;/users/user2207/lbm_opt/src/lbm_phys.c:168;VSUBSD	%XMM11,%XMM2,%XMM2;
0x3eba;/users/user2207/lbm_opt/src/lbm_phys.c:167;VFMADD132SD	%XMM3,%XMM13,%XMM10;
0x3ebf;/users/user2207/lbm_opt/src/lbm_phys.c:161;VDIVSD	%XMM14,%XMM1,%XMM1;
0x3ec4;/users/user2207/lbm_opt/src/lbm_phys.c:168;VFMADD132SD	%XMM3,%XMM12,%XMM2;
0x3ec9;/users/user2207/lbm_opt/src/lbm_phys.c:167;VFMADD231SD	%XMM1,%XMM15,%XMM10;
0x3ece;/users/user2207/lbm_opt/src/lbm_phys.c:168;VFMADD132SD	%XMM1,%XMM2,%XMM15;
0x3ed3;/users/user2207/lbm_opt/src/lbm_phys.c:167;VMOVSD	%XMM10,0x28(%RAX);
0x3ed8;/users/user2207/lbm_opt/src/lbm_phys.c:168;VMOVSD	%XMM15,0x40(%RAX);
0x3edd;/users/user2207/lbm_opt/src/lbm_phys.c:168;JMP	3ac3 <special_cells._omp_fn.0+0x113>;
