_report = {
  metrics = {
    ...
    loops_time = 30.01,
    speedup_if_fp_vect = 1.2143,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 2.8126526620669,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.9557380911107,
    ...
    speedup_if_fully_vectorised = 1.3093,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1.1621758255807,
    speedup_if_clean = 1.1325,
    profiled_time = 0.88,
    array_access_efficiency = 50.641975308642,
    crest_performance = "Not Implemented Yet",
    number_processes = 32,
    speedup_if_FP_only = 1.2289,
    nb_threads = 32,
    application_time = 5.2103729248047,
    compilation_options = "OK",
    innerloops_time = 29.44,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 0.26 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.26 seconds.",
  },
  colors = {
