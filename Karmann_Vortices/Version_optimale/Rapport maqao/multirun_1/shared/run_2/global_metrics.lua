_report = {
  metrics = {
    ...
    loops_time = 81.92,
    speedup_if_fp_vect = 1.9172,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.2228057807011,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.1912115062208,
    ...
    speedup_if_fully_vectorised = 2.786,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1.5763058117344,
    speedup_if_clean = 1.4443,
    profiled_time = 2.43,
    array_access_efficiency = 50.553250345781,
    crest_performance = "Not Implemented Yet",
    number_processes = 4,
    speedup_if_FP_only = 1.9942,
    nb_threads = 4,
    application_time = 3.0690219402313,
    compilation_options = "OK",
    innerloops_time = 80.32,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 1.99 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 1.95 seconds.",
  },
  colors = {
