_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 7.3839,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1.778913385371,
    speedup_if_clean = 1.6067,
    profiled_time = 114.9,
    array_access_efficiency = 67.224712215047,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.1442,
    nb_threads = 1,
    application_time = 118.13316345215,
    compilation_options = "lbm:  -funroll-loops is missing. \n",
    innerloops_time = 98.66,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 113.42 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 113.36 seconds.",
  },
  colors = {
