_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 7.379,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1.7711939239514,
    speedup_if_clean = 1.602,
    profiled_time = 115.2,
    array_access_efficiency = 67.224088577125,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.1388,
    nb_threads = 1,
    application_time = 118.51152801514,
    compilation_options = "lbm:  -funroll-loops is missing. \n",
    innerloops_time = 98.65,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 113.70 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 113.64 seconds.",
  },
  colors = {
