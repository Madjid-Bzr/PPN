_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 7.3797,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1.7711939239514,
    speedup_if_clean = 1.6017,
    profiled_time = 114.82,
    array_access_efficiency = 67.241335731032,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.1383,
    nb_threads = 1,
    application_time = 118.03076934814,
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 113.33 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 113.25 seconds.",
  },
  colors = {
