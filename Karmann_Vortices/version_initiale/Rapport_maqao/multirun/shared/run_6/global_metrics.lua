_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 7.4095,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1.7753094745562,
    speedup_if_clean = 1.6053,
    profiled_time = 115.07,
    array_access_efficiency = 67.241371537089,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.1433,
    nb_threads = 1,
    application_time = 118.18019104004,
    compilation_options = "lbm:  -funroll-loops is missing. \n",
    innerloops_time = 98.69,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 113.65 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 113.56 seconds.",
  },
  colors = {
