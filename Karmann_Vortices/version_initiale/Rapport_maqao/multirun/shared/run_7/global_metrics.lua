_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 7.34,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1.7750913449735,
    speedup_if_clean = 1.6023,
    profiled_time = 114.4,
    array_access_efficiency = 67.232835907633,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.1379,
    nb_threads = 1,
    application_time = 117.54820251465,
    compilation_options = "lbm:  -funroll-loops is missing. \n",
    innerloops_time = 98.57,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 112.82 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 112.76 seconds.",
  },
  colors = {
