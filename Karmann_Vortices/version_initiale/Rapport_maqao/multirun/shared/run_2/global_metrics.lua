_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 7.3798,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1.7714569911904,
    speedup_if_clean = 1.6018,
    profiled_time = 115.35,
    array_access_efficiency = 67.250610229625,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.1386,
    nb_threads = 1,
    application_time = 118.56992340088,
    compilation_options = "lbm:  -funroll-loops is missing. \n",
    innerloops_time = 98.6,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 113.86 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 113.74 seconds.",
  },
  colors = {
