_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 7.3742,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1.7731289971283,
    speedup_if_clean = 1.6028,
    profiled_time = 115.24,
    array_access_efficiency = 67.227305959904,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.1399,
    nb_threads = 1,
    application_time = 118.44622802734,
    compilation_options = "lbm:  -funroll-loops is missing. \n",
    innerloops_time = 98.63,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 113.74 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 113.66 seconds.",
  },
  colors = {
