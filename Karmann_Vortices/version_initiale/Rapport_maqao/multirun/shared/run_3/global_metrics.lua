_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 7.3903,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1.7714684651924,
    speedup_if_clean = 1.6025,
    profiled_time = 114.83,
    array_access_efficiency = 67.24732502754,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.1394,
    nb_threads = 1,
    application_time = 118.03048706055,
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 113.38 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 113.28 seconds.",
  },
  colors = {
