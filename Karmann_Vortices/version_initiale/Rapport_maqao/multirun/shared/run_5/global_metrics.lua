_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 7.3907,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1.7734041386297,
    speedup_if_clean = 1.6035,
    profiled_time = 115.22,
    array_access_efficiency = 67.256443125349,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.1411,
    nb_threads = 1,
    application_time = 118.32550048828,
    compilation_options = "lbm:  -funroll-loops is missing. \n",
    innerloops_time = 98.62,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 113.75 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 113.63 seconds.",
  },
  colors = {
